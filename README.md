...
* [`src/mtg_app/`](src/mtg_app/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/mtg_app/core.cljs): contains the SPA entry point, `init`
* [`test/mtg_app/`](test/mtg_app/): test files (ClojureScript,
...
5. Clone this repo and open a terminal in the `mtg-app` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/mtg_app/config.cljs) defaults to `true` in
...
```clj
(ns mtg-app.example
  (:require [mtg-app.config :as config])
